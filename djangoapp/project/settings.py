...
# Local dos arquivos estaticos e de media
# /data/web/static
# /data/web/media
...
# obter as variáveies de ambiente garantindo que retorne um inteiro
# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = bool(int(os.getenv('DEBUG', 0)))

# cria uma lista separados por virgula e impedindo que tenha espaços em branco
